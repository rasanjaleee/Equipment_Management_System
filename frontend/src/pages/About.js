      ...
      <div className="max-w-[1100px] mx-auto bg-white rounded-xl shadow-md p-8 my-8">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[{
              img: "/images/electrical_machine.jpg",
