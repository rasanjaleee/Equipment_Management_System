    ...
    <div className="bg-gray-50 text-gray-700">
      ...
      <div className="max-w-[1100px] mx-auto bg-white rounded-xl shadow-md p-8 my-8">
        ...
        <section className="mb-8">
          <h2 className="text-gray-900 border-l-4 border-yellow-500 pl-3 mb-2 text-xl font-bold">
            Overview
          </h2>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-8 leading-relaxed text-gray-600 text-sm">
        ...
        {/* LABS GRID */}
        <section className="mb-8">
          <h2 className="text-gray-900 border-l-4 border-yellow-500 pl-3 mb-4 text-xl font-bold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[{
              ...
              <div key={index} className="bg-gray-50 rounded-lg border border-yellow-300 p-4 transition duration-300 hover:shadow-md hover:-translate-y-1">
                <img
                  src={lab.img}
                  alt={lab.title}
                  className="w-full h-[150px] object-cover rounded-md mb-3"
                />
                <h3 className="font-semibold text-sm text-gray-900 mb-1">{lab.title}</h3>
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-lg border border-yellow-300 p-4">
              <h3 className="font-semibold text-sm text-gray-900 mb-2">Vision</h3>
              <p className="leading-relaxed text-gray-600 text-sm">
            ...
            <div className="bg-gray-50 rounded-lg border border-yellow-300 p-4">
              <h3 className="font-semibold text-sm text-gray-900 mb-2">Mission</h3>
              <p className="leading-relaxed text-gray-600 text-sm">
        ...
        <section className="mb-8">
          ...
          {/* FULL-WIDTH MAP */}
          <div className="w-full h-[350px] rounded-lg overflow-hidden shadow-sm border border-yellow-300 mb-6">
            <iframe
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-sm text-gray-900 mb-1">Postal Address</h4>
              <p className="leading-relaxed text-gray-600 text-sm">
